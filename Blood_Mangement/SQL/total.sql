...
INSERT INTO member
(member_id, login_id, password, name, phone, member_type, mcreated_at)
VALUES
(1, 'hong123', 'Yun!4827qa', '조현우', '010-1234-5678', '헌혈자', '2026-08-16'),

(2, 'kim123', 'Blue#7315K', '최윤성', '010-2222-3333', '수혈자', '2026-08-17'),

(3, 'seou01', 'Mango@9042z', '구현승', '010-3333-4444', '헌혈자', '2026-08-17'),

(4, 'park77', 'Tree$6183Lm', '최정우', '010-4444-5555', '헌혈자', '2026-08-18'),

(5, 'lee100', 'Cloud!5279p', '이서연', '010-5555-6666', '수혈자', '2026-08-18'),

(6, 'choi88', 'River#8406X', '김도윤', '010-6666-7777', '헌혈자', '2026-08-18'),

(7, 'minji22', 'Star@3158nb', '김민지', '010-7777-8888', '헌혈자', '2026-08-19'),

(8, 'jpark55', 'Green$6924Q', '정지훈', '010-8888-9999', '수혈자', '2026-08-19'),

(9, 'sora33', 'Moon!7531rk', '한소라', '010-9999-0000', '헌혈자', '2026-08-19'),

(10, 'yoon10', 'Data#4268Vt', '윤지호', '010-1111-2222', '헌혈자', '2026-08-19');
